...
import dk.trustworks.essentials.spring.examples.postgresql.messaging.shipping.adapters.kafka.incoming.OrderAccepted;
import dk.trustworks.essentials.spring.examples.postgresql.messaging.shipping.adapters.kafka.incoming.OrderEventsKafkaListener;
import dk.trustworks.essentials.spring.examples.postgresql.messaging.shipping.adapters.kafka.outgoing.ExternalOrderShipped;
