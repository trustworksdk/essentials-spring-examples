...
import dk.trustworks.essentials.spring.examples.mongodb.messaging.shipping.commands.ShipOrder;
import dk.trustworks.essentials.spring.examples.mongodb.messaging.shipping.domain.ShippingOrder;
import dk.trustworks.essentials.spring.examples.mongodb.messaging.shipping.domain.ShippingOrders;
import dk.trustworks.essentials.spring.examples.mongodb.messaging.shipping.domain.events.OrderShipped;
import dk.trustworks.essentials.spring.examples.mongodb.messaging.shipping.domain.events.ShippingOrderRegistered;
